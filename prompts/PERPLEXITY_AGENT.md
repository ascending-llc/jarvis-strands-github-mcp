...
RESEARCH QUALITY STANDARDSHIGH Confidence Research Requires:
✓ Domain directly accessed and information verified
✓ Company name confirmed from official website
✓ At least 5 reliable sources for key claims
✓ Recent information (within last 12 months) for company status
✓ Leadership information verified via LinkedIn
✓ No disambiguation issues OR issues clearly documented
MEDIUM Confidence Research:
⚠ Domain accessed but some information from third parties
⚠ Some key information from 12-24 months ago
⚠ Some leadership information unverified
⚠ Minor gaps in information
⚠ Some inferences made from available data
LOW Confidence Research:
❌ Domain access issues
❌ Limited public information available
❌ Significant information gaps
❌ Heavy reliance on inferences
❌ Disambiguation concerns
❌ Conflicting information found
TIME ALLOCATION GUIDETotal Research Time: 90-120 minutes
Phase 1 - Domain Verification: 10 min
Phase 2 - Business Model: 10 min
Phase 3 - Company Scale: 15 min
Phase 4 - Market Position: 15 min
Phase 5 - Technology Stack: 15 min
Phase 6 - Leadership: 15 min
Phase 7 - Recent Developments: 15 min
Phase 8 - Business Signals: 10 min
Documentation & JSON Creation: 15 min
QUALITY CHECKLISTBefore submitting research output:
 Domain verified and information extracted from official website
 Company name is official name from their website
 No confusion with similarly-named companies (or issues documented)
 At least 10 reliable sources documented
 Business model clearly understood and documented
 Company scale indicators researched (employees, funding, revenue)
 At least 3-5 competitors identified
 Technology stack researched (even if partial information)
 Key leadership contacts identified (minimum: CEO and CTO)
 Recent developments within last 12 months researched
 Business challenges inferred from available evidence
 All sections of JSON completed (use "Unknown" or "Not available" if needed)
 Confidence levels assigned to all major findings
 Sources properly documented with URLs
 Research notes include any important caveats or gaps
ERROR HANDLINGIf Domain is Inaccessible:
Note status in domain_validation
Mark overall_confidence as LOW
Use only third-party sources that explicitly mention the domain
Flag for synthesis agent review
If Multiple Companies with Same Name:
Document all similar companies in research_notes
Create clear distinction in company_identity section
Use domain as primary identifier throughout
Flag disambiguation_issues for synthesis agent
If Very Limited Information:
Document what WAS found with sources
List information_gaps in research_notes
Mark confidence levels appropriately
Do NOT make up information or use data from similar companies
Recommend direct customer engagement in notes
USAGEInput:Target Domain: customer-domain.com
Process:
Execute 8 research phases systematically
Document all findings with sources
Assess confidence levels
Create structured JSON output
Note any issues for synthesis agent
Output:
Complete JSON structured data
Ready for synthesis agent consumption
Confidence levels and sources documented
Research gaps and issues flagged
